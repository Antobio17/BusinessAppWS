...
\multicolumn{3}{|l|}{\begin{tabular}[c]{@{}l@{}}
    ...
    sus datos de la base de datos del sistema
\end{tabular}} \\ \hline
\end{tabular}
\end{table}
...
\multicolumn{3}{|l|}{\cellcolor[HTML]{EFEFEF}\textbf{Propósito}} \\ \hline
\multicolumn{3}{|l|}{
    Consultar los datos propios como usuario super-administrador del sistema
} \\ \hline
\multicolumn{3}{l}{} \\ \hline
\rowcolor[HTML]{EFEFEF}
\multicolumn{3}{|l|}{\cellcolor[HTML]{EFEFEF}\textbf{Resumen}} \\ \hline
\multicolumn{3}{|l|}{\begin{tabular}[c]{@{}l@{}}
    Se podrá consultar los datos propios como usuario \\
