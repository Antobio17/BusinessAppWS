...
\vspace{0.5cm}
\noindent{\textbf{Palabras clave}: \textit{desarrollo web}, \textit{aplicación móvil}, \textit{APIRest}, \textit{multigestión}}
\vspace{0.7cm}

\noindent{\textbf{Resumen}\\
	
En el presente Trabajo de Fin de Grado se expondrá el proceso de creación de una API donde será posible gestionar
...
tendrán la necesidad de atender a esos clientes y podrán seguir concentrados en su trabajo.

Por otra parte el diseño del modelo de datos y la administración de la misma también tiene un papel importante.
En esta deberá haber roles de usuarios donde determinados usuarios puedan acceder a determinados datos.
...
ha sido realizado bajo mi supervisión por \textbf{Antonio Jiménez Rodríguez}, y autorizo la defensa de dicho trabajo ante el tribunal
que corresponda.
